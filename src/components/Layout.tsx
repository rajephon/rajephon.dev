...
import { siteConfig, navigationItems, getPageTitle, getPageUrl, getOGImageUrl } from '@/lib/config';
  ...
  return (
    <div className={`min-h-screen bg-white dark:bg-gray-900 ${isDarkMode ? 'dark' : ''}`}>
      <Head>
        ...
        <meta property="og:image:alt" content={siteConfig.seo.openGraph.images[0].alt} />
      ...
      {showNavigation && (
      <header className="bg-white dark:bg-gray-800 shadow-sm border-b border-gray-200 dark:border-gray-700" role="banner" data-testid="header">
        <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8" role="navigation" data-testid="navigation">
